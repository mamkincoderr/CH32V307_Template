...
Доступны: точки останова, просмотр переменных и регистров периферии (SVD уже в репозитории).
...
Папка `doc/` содержит всю необходимую документацию:

| Файл | Описание |
|------|----------|
| `CH32V307_Datasheet.pdf` | Datasheet CH32V20x/30x (характеристики, пины, электрика) |
| `CH32V307_RM.pdf` | Reference Manual — полное описание всей периферии |
| `QingKe_V4F_Core_Manual.pdf` | Мануал ядра QingKe V4F (RISC-V RV32IMAFCXW) |
| `CH32V307.svd` | SVD-файл для просмотра регистров периферии в отладчике |
